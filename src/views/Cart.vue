<template>
    <div>
                            ...
                            <li v-for="item in cartList">
                                <div class="cart-tab-1">
                                    ...
                                    <div class="cart-item-pic">
                                        <img v-lazy="'/static/'+item.productImage" v-bind:alt="item.paroductName">
                                    </div>
                                    <div class="cart-item-title">
                                        <div class="item-name">{{item.paroductName}}</div>
                                    </div>
                                </div>
        ...
        <modal :mdShow="modalConfirm" @close="closeModal">
            ...
            <div slot="btnGroup">
                <a class="btn btn--m  btn--red" href="javascript:;" @click="delCart">确认</a>
